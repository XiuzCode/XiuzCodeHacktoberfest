# This is a word game
import random
words = ["another","call","against","last","number","show","most","child","one","feel","part","ask","place","few","about","might","turn","long","while","so","small","problem","during","word","live","system","area","write","again","follow"]
